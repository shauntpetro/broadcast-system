...
function broadcast(type, data, options = {}) {
  ...
  // Some messages should be sent immediately (e.g., connection status, pin updates)
  const immediateTypes = ['status', 'error', 'init', 'slideshow_init', 'sports_ticker_init', 'state_delta', 'pin', 'queue_update'];
